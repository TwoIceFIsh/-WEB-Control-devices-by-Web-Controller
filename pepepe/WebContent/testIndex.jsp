...
<body>
	...
	<div id="page-wrapper">
		<div class="row">
			...
			<div class="col-lg-6 col-md-6">
				<h3>발표 후 SMARTGREENHOUSE.CF에서 관리자 아이디로 직접조작해보세요!</h3>
			</div>
			<!-- /.col-lg-12 -->
		</div>
		<!-- /.row -->
		<div class="row">
			<div class="col-lg-3 col-md-6">
				<div class="panel panel-primary">
					<div class="panel-heading" onClick='ledF()'>
						<div class="row">
							<div class="col-xs-3">
			...
			<div class="col-lg-3 col-md-6">
				<div class="panel panel-green">
					<div class="panel-heading" onClick='waterF()'>
						<div class="row">
							<div class="col-xs-3">
			...
			<div class="col-lg-3 col-md-6">
				<div class="panel panel-yellow">
					<div class="panel-heading" onClick='penF()'>
						<div class="row">
							<div class="col-xs-3">
			...
			<div class="col-lg-3 col-md-6">
				<div class="panel panel-red">
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-3">
								<i class="fa fa-arrow-up   fa-3x" onclick="screenUp()"></i> <i
									class="fa fa-arrow-down fa-3x" onclick="screenDown()"></i>
							</div>
							<div class="col-xs-9 text-right">
				...
				<div class="chat-panel panel panel-default">
					...
					<div class="content">
						...
						<div class="wrap">
							...
							<button id="btn-mic" class="off" onclick="hello()">
								말하기 <span></span>
							</button>
